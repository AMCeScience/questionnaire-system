...
$config['generic_questions'] = [
  ...
  '3' => [
    ...
    'answers' => [
      ...
      '3' => 'Information from colleagues/peers',
  ...
  '5' => [
    ...
    'answers' => [
      '1' => 'Quality of the user documentation',
      '2' => 'Information about the tool (e.g. tool\'s website)',
      '3' => 'Colleagues/peers using it',
      '4' => 'Availability of scientific literature about the tool',
      '5' => 'Own experience with the tool'
    ],
    'other' => true
  ],
  '6' => [
...
$config['specific_questions'] = [
  '1' => [
    ...
    'answers' => [
      '1' => 'My organisation',
      '2' => 'Colleagues in my organisation',
      '3' => 'Peers (e.g. web forums/conferences/scientific papers)',
      '4' => 'School/training',
      '5' => 'Newsletter/advertisement',
      '6' => 'Searches (e.g. web)',
  ...
  '3' => [
    ...
    'answers' => [
      ...
      '6' => 'Data extraction',
      '7' => 'Risk of bias',
      '8' => 'Evidence synthesis (quantitative/qualitative)',
    ],
    'other' => true
  ],
  '4' => [
  ...
  '5' => [
    ...
    'answers' => [
      '1' => 'Not supported by organisation',
      '2' => 'Licensing costs',
      '3' => 'More difficult to use',
      '4' => 'Less well integrated in my workflow',
      '5' => 'Lacking documentation',
      '6' => 'Lacking scientific underpinning of method/algorithm',
      '7' => 'I don’t trust the results',
      '8' => 'The tool does not explain to me how it generates the results',
      '9' => 'Results are not as usable in my workflow',
  ...
  '11' => [
    'name' => 'voluntary_use',
    'type' => 'radio',
    'question' => 'Do you use this tool of your own free will?',
    'answers' => [
      'free' => 'I use this tool of my own free will',
